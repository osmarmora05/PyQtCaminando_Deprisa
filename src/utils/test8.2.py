...
# Se agregan las tablas por separadas, solo falta hecer click y que se llenen bien los campos
...
class InfoWindow(QDialog):
    def __init__(self, data, parent=None):
        ...
        self.tables = {}  # Diccionario para mantener las tablas
        layout = QVBoxLayout()
        ...
        for table_name, table_data in data.items():
            ...
            self.tables[table_name] = table  # Agregar la tabla al diccionario
