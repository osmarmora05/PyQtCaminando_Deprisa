...
class Inventario(QWidget):
    def __init__(self):
        ...
        self.text_boxes = {}
        self.widgets = []
        self.info_window = None  # Inicializar el atributo info_window como None
    ...
    def on_button_clicked(self):
        ...
        if self.info_window is None:  
            ...
            self.info_window.table.setRowCount(self.info_window.table.rowCount() + 1)
            for col, (field_id, value) in enumerate(data.items()):
                self.info_window.table.setItem(self.info_window.table.rowCount() - 1, col, QTableWidgetItem(str(value)))
